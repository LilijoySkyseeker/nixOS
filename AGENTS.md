...
| `docs/hardening.md` | Security-hardening conventions (sudo/run0, dedicated service users, systemd sandboxing, SSH lockdown, swap, rate-limiting). Opens with **ten standing rules** harvested from the 2026-08-26 audit — secrets, network exposure, privilege, backups, verification, containers. Read those before adding a service or opening a port. |
