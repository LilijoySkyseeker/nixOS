  ...
  outputs = inputs @ {
    ...
    vars = {
      publicSshKeys = [
        ...
        "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIAypopQudKUHc7dJPJ3iiqqOFw0rzhomobLsWsr1CC4bAAAABHNzaDo= lilijoy@yubikey" # yubikey
      ];
    };
