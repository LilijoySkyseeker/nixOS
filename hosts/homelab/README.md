...
- `tailscale0`: TCP 22,445,2049,2283,5984,8096,25565 / UDP 19132,25565,34197
...
`android-smb`, `fwupd-refresh`, `health-check`, `immich`, `jellyfin`, `nm-iodine`, `nscd`, `octodns`, `redis-immich`, `sshd`, `systemd-oom`, `wpa_supplicant`

### Secrets in use

`cloudflare_octodns_token`, `discord_webhook`, `factorio_game_password`, `factorio_token`, `factorio_username`, `git_email`, `git_username`, `homelab_backblaze_rclone_config`, `homelab_backblaze_restic_password`, `homelab_couchdb_admin_password`, `homelab_couchdb_sync_password`, `homelab_samba_android_smb_password`, `homelab_vps_deploy_key`, `homelab_wireguard_private_key`, `homelab_zrepl_key`, `minecraft_username`, `tailscale_authkey_homelab`, `wireguard_vps_homelab_psk`
<!-- inventory:end -->
